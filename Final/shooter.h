...
public:
    ...
    // Function to change color of shooter
    void setColor(Color new_color) // The setColor for rectangles and shooter have same name, but work as one shadow the other
    {
        body.setColor(new_color);
        head.setColor(new_color);
    }
};
